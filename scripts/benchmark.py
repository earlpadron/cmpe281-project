...
if __name__ == "__main__":
    ...
    bench = BenchmarkFramework(bucket_name='cmpe281-data-dataset', lambda_name='cmpe281-shared-image-resizer')
    print(f"Initial Hardware Metrics: {bench.get_hardware_metrics()}")
    bench.run_benchmark(limit=1000) # Run a quick test with 10 images
